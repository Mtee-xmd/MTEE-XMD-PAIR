    ...
    const {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let desc = `*Hello there MTEE-XMD User! 👋🏻* 

> Do not share your session id with your gf 😂.

 *Thanks for using MTEE-XMD 🚩* 
...
{quoted:code })
                            ...
                            let desc = `*Don't Share with anyone this code use for deploy MTEE-XMD*\n\n ◦ *Github:* https://github.com/Mtee-xmd/MTEE-XMD `;
                            await sock.sendMessage(sock.user.id, {
text: desc,
contextInfo: {
externalAdReply: {
